      ...
      <div className="w-full max-w-[430px] mx-auto py-8 px-4 flex flex-col justify-center">
        ...
        {submitted ? (
          ...
          >
            ...
            <h3 className="text-base font-bold font-display text-[#F0F0F0]">Check Your Inbox</h3>
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-2 text-xs font-semibold text-[#E87722] hover:underline pt-2"
            >
